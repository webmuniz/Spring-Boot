...
public class DevDojoWebMvcConfigurer implements WebMvcConfigurer {
    ...
    //Configuring the amount of pages that the API will return and the amount per page.
    @Override
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> resolvers) {
        final PageableHandlerMethodArgumentResolver pageableHandler = new PageableHandlerMethodArgumentResolver();
